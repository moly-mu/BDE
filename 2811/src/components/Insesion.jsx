        ...
        <div className="bg-white rounded-lg shadow-lg p-8 w-full max-w-5xl flex flex-col md:flex-row items-center space-y-8 md:space-y-0">
          ...
          <div className="w-full md:w-1/2">
            ...
            <form className="flex flex-col space-y-6" onSubmit={handleSubmit}>
              ...
              <a
                href="#"
                className="text-sm text-blue-800 hover:underline self-end">
                ¿Olvidaste tu contraseña?
              </a>
              <button
                type="submit"
                className="bg-[#00102D] text-white py-3 px-6 text-lg rounded hover:bg-blue-700 w-full">
                Ingresar
              </button>
              <p className="text-center text-lg">
                ¿No tienes cuenta?{" "}
                <Link to="/Reg" className="text-blue-800 hover:underline">
                  Regístrate
                </Link>
              </p>
