...
const Header = ({ sectionTitle, user, onLogout }) => {
  const navigate = useNavigate();
  const [menuOpen, setMenuOpen] = useState(false); // Estado para controlar el menú

  return (
    <>
      <header className="bg-white shadow-md p-6 rounded-b-xl font-poppins">
        <div className="flex justify-between items-center">
          ...
          <div className="flex flex-col items-center">
            <div
              ...
              onClick={() => navigate("/")}
            >
              <span className="text-6xl font-extrabold text-yellow-500 transform transition-transform hover:scale-125">
                U
              </span>
              <span className="text-6xl font-extrabold text-blue-500 transform transition-transform hover:scale-125">
                D
              </span>
              <span className="text-6xl font-extrabold text-red-500 transform transition-transform hover:scale-125">
                C
              </span>
