        ...
        <div className="space-y-4">
          ...
          <div className="border-b border-gray-300 pb-4">
            <p className="text-lg text-gray-800">
              <strong className="text-blue-600">
                <FaIdCard className="inline-block mr-2 text-orange-600" />
                Tipo de Documento:
              </strong>
          ...
          <div className="border-b border-gray-300 pb-4">
            ...
            <button
              ...
              className="mt-4 flex items-center justify-center gap-2 px-4 py-2 bg-yellow-600 text-white rounded-lg hover:bg-yellow-700 transition duration-300 shadow-md"
            >
              Actualizar Datos
            </button>
          </div>
